...
\newpage
    ...
    \hugesp
    \frq{Find the points on the graph $y=4-2x^2$ that are closest to $(0,-4)$. Hint: remember that the distance between the points $(x,y)$ and $(a,b)$ is $d=\sqrt{(x-a)^2+(y-b)^2}$. Also remember that minimizing $d$ is the same as minimizing $d^2$.}
    \hugesp
    ...
    \mcq{Let $f(x)=\dfrac{1}{16}x^2-\dfrac{x+1}{x}$.}{
        ...
        \hugesp
        \task Find the exact value of the area between the curve $f(x)$ and the $x$-axis for $-3\leq x\leq -1$.
    }
