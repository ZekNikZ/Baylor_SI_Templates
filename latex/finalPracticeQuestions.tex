    ...
    \begin{center}
        \framebox{
            \begin{minipage}{\textwidth}
                \begin{center}
                    \textbf{This list of problems is not intended to be comprehensive of\linebreak all the material on your final, but it should be good practice.}
                \end{center}
                \begin{enumerate}
                    ...
                    \item Work through some or all of these leading up to your final.
                    \item This list is intended to be \underline{supplemental} to your own final review. Please do not only use this and the practice test to study for your final.
                \end{enumerate}
                \begin{center}
