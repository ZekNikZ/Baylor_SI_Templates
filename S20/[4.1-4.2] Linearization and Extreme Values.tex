...
\sessiondate{3/24/20}   % the date of the session
...
\begin{document}
    ...
    \frq{Estimate $\Delta f=f(2.01)-f(2)$ for $f(x)=\dfrac{1}{x+2}$. Then find the linearization of $f$ that corresponds to your answer.}
    \hugesp
