...
\begin{document}
    ...
    \activity{Activity 2}{Applications of Derivatives}{Make a \textbf{{\em new} group of three, all with different colored worksheets,} to answer these questions. Try not to use your notes.}{30 minutes}
