...
\warmup{SI Info}
\topic{Algebra, Rational Functions, and Exponents}
\topic{Trigonometry}
\cooldown{Function Properties}
...
\begin{document}
    ...
    \activity{Activity 1}{Algebra, Rational Functions, and Exponents}{Try these problems \textbf{alone} then \textbf{compare your answers} with those sitting around you.}{20 minutes}
    ...
    \frq{Solve for $x$:}
    $$\dfrac{x}{2x-3}=\dfrac{3x}{x+11}$$
    \normalsp

    \activity{Activity 2}{Prior Knowledge Quiz, Part 2}{Create a group of 3-4 \textbf{all with matching worksheet colors} to work on these problems together.}{20 minutes}
    ...
    \mcq{Find $x$ such that}{
        \task $\cos(x)=\dfrac{\sqrt{3}}{2}$
        \Tinysp
        \task $x = \csc\left(\dfrac{2\pi}{3}\right)$
    }
    \newpage
    
    \activity{Cooldown}{Function Properties}{Work with your same group to answer these problems together.}{10 minutes}
