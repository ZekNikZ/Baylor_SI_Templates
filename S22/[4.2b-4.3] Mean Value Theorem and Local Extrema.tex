...
\sessiondate{10/25/21}   % the date of the session
...
\begin{document}
    ...
    \activity{Activity 1}{Local Extrema}{Make a \textbf{group of two or three, all with different colored worksheets,} to answer your assigned question. Then, try to answer the other questions. Try not to use your notes.}{30 minutes}
...
\newpage
    ...
    \activity{Activity 2}{Mean Value Theorem}{Make a \textbf{group of two or three, all with the same colored worksheets,} to answer your assigned question. Then, try to answer the other questions. Try not to use your notes.}{30 minutes}
    ...
    \frq{Find $c$ satisfying the conclusions of the Rolle's Theorem for $y=x^3$ on the interval $[-5,4]$. }
    \newpage
