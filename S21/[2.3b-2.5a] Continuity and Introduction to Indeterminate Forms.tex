...
\pagebreak
    ...
    \mcq{Compute the following limits. If the limit does not exist, determine the one-sided limits and state if a limit approaches $\pm \infty$}{
        \task $\lim\limits_{x\to3}\dfrac{x-3}{x^2+x-6}$
        \Smallsp
