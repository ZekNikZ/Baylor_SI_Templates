    ...
    \framebox{
        \begin{minipage}{\textwidth}
            ...
            \begin{enumerate}
                ...
                \item Time yourself, make sure you are completing the problems at a comfortable pace. Remember that you will only get \textbf{75 minutes} for the actual exam (with fewer questions of course).
                \item The answer key will be available at the test review session on \textbf{10/13/21 from 6:00-8:00 pm}.
...
\newpage
    ...
    \frq{Find the derivative of $g(x)=x^{\sin x}$ using logarithmic differentiation.}
    \newpage
