...
\begin{document}
        ...
        \framebox{
            \begin{minipage}{\textwidth}
                ...
                \begin{enumerate}
                    ...
                    \item The answer key will be available at the test review session on \textbf{9/15/21 from 6:00-7:30 pm}.
    ...
    \begin{multipartquestion}
        ...
        \largesp
        \frq{$\lim\limits_{x\to\infty}\dfrac{\sin x}{x}$} % Squeeze Theorem!
        \Normalsp
    \end{multipartquestion}
