...
\sessiondate{11/3/21}   % the date of the session
...
\begin{document}
    ...
    \activity{Activity 1}{Finding the Objective Function}{Work \textbf{as a class} to answer these questions. Try not to use your notes.}{15 minutes}
